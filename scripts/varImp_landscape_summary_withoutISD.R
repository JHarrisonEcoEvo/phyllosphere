...
results <- read.csv("modelingResults/results_hella_noduds/all_its_hella_noduds.csv", stringsAsFactors = F)
...
varimps <- lapply(paste("modelingResults/results_hella_noduds/noduds_", dat, sep = ""), read.csv)
...
# long &  60 \\ 
# lat &  55 \\ 
# precip\_april\_in.x &  53 \\ 
# habit\_tree &  53 \\ 
# shannons\_flora &  52 \\ 
# shrubRich &  51 \\ 
# MEM2 &  51 \\ 
# mean\_temp\_april.y &  50 \\ 
# plant\_vol &  49 \\ 
# Ambient\_Temperature &  45 \\ 
# \hline
# \end{tabular}
# \end{table}
...
#VERSION FOR HELLINGER data that included ISD and non-target reads in the denominator
rm(list=ls())
