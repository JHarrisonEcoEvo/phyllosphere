...
###################################################
rm(list=setdiff(ls(), c("out","taxa","inargs","possibles","focal_taxon")))
library(mlr3) #cant get mlr3 to install on work computer
#library(xgboost)
#install.packages("mlr3learners")
library(mlr3learners)
...
###################################################
rm(list=setdiff(ls(), c("out","taxa","possibles","focal_taxon","inargs")))
library(mlr3) #cant get mlr3 to install on work computer
#library(xgboost)
#install.packages("mlr3learners")
library(mlr3learners)
...
write.csv(out, file = paste("results", focal_taxon, "16S_countAbundance_NOHOST.csv", sep = ""), row.names = F)
