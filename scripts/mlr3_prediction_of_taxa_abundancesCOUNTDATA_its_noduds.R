...
write.csv(var.imp, file = paste("noduds_variableImportance", focal_taxon, isdNorm_tf, "ITS.csv", sep = ""), row.names = T)
# 
# ##########################################
...
# write.csv(var.impR, file = paste("variableImportanceReduced", focal_taxon,isdNorm_tf,  "ITS.csv", sep = ""), row.names = T)
write.csv(out, file = paste("noduds_results", focal_taxon,isdNorm_tf,  "ITS.csv", sep = ""), row.names = T)
