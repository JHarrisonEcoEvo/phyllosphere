...
# possibles <- read.csv("./processedData/sixteenS_taxa_to_model_via_randomforest.csv")
...
write.csv(var.imp, file = paste("variableImportance", focal_taxon, isdNorm_tf, "16S.csv", sep = ""), row.names = T)
write.csv(out, file = paste("results", focal_taxon,isdNorm_tf,  "16S.csv", sep = ""), row.names = T)
