...
write.csv(var.imp, file = paste("HOSTvariableImportance_RelAbund", focal_taxon, "_", focal_host, "16S.csv", sep = ""), row.names = F)
...
write.csv(out, file = paste("HOSTresults_RelAbund", focal_taxon,"_", focal_host, "16S.csv", sep = ""), row.names = F)
