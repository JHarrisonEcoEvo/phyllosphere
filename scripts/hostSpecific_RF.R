...
# focal_taxon <- possibles[2,2]
# focal_host <- possibles[2,3]
...
# possibles <- read.csv("./processedData/sixteenS_otus_to_analyze.csv", stringsAsFactors = F)
# focal_taxon <- possibles[2,2]
# focal_host <- possibles[2,3]
