...
write.csv(var.imp, file = paste("HOSTvariableImportance", focal_taxon, "_", focal_host, "16S_HELLINGER.csv", sep = ""), row.names = F)
...
write.csv(var.impR, file = paste("HOSTvariableImportanceReduced", focal_taxon, "_", focal_host, "16S_HELLINGER.csv", sep = ""), row.names = F)

write.csv(out, file = paste("results", focal_taxon,"_", focal_host, "16S_HELLINGER.csv", sep = ""), row.names = F)
