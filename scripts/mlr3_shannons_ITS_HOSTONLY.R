...
write.csv(var.imp, file = paste("variableImportanceshannonsISD_ITS_HOSTONLY.csv"), row.names = T)
...
write.csv(var.impR, file = paste("variableImportanceReducedshannonsISD_ITS_HOSTONLY.csv"), row.names = T)

write.csv(out, file = paste("results_shannonosISD_ITS_HOSTONLY.csv"), row.names = F)
