...
write.csv(var.imp, file = paste("variableImportance", focal_taxon, "ITS_NOHOST.csv", sep = ""), row.names = T)
write.csv(out, file = paste("results", focal_taxon, "ITS_NOHOST.csv", sep = ""), row.names = T)