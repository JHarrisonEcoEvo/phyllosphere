...
results <- read.csv("modelingResults/results_host_occupancy/all_ITS.csv", stringsAsFactors = F)
...
results <- read.csv("modelingResults/results_host_occupancy/all_16S.csv", stringsAsFactors = F)
