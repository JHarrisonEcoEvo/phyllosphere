...
mean_densitometer <- aggregate(dat$daubPlots__denso ~ 
                                 dat$siteLabel, FUN = mean)

write.csv(mean_densitometer, 
          file = "./processedData/densitometer_mean_vs_site.csv", row.names = F)
