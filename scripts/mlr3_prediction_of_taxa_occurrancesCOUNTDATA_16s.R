...
# out$mcc_reduced  <- rr$aggregate(measure = msr("classif.mcc")) #can swap out different measures
# 
...
# 
# write.csv(var.impR, file = paste("variableImportanceReduced", focal_taxon, "16S_hellingerOCCUPANCY.csv", sep = ""), row.names = T)
