...
pdf(width = 5,height = 6, file = "./visuals/phyla_its_compartment_barplot.pdf")
...
pdf(width = 12,height = 9, file = "./visuals/phyla_its_taxon_final_barplot.pdf")
# Get the stacked barplot
...
# legend #
##########
pdf(width = 3,height = 6, file = "./visuals/phyla_its_barplot_legend.pdf")
...
pdf(width = 12,height = 9, file = "./visuals/phyla_16s_taxon_final_barplot.pdf")
# Get the stacked barplot
par(mar = c(3,6,1,1), oma = c(16,3,1,1))
...
pdf(width = 5,height = 6, file = "./visuals/phyla_16s_compartment_barplot.pdf")
# Get the stacked barplot
par(mar = c(3,6,1,1), oma = c(2,2,2,2))
barplot(as.matrix(wide[,2:3]), 
        col=colors_new, 
