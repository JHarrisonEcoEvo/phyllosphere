...
write.csv(var.imp, file = paste("HOSTvariableImportance", focal_taxon, "_", gsub(" ","",focal_host), "ITS.csv", sep = ""), row.names = T)
...
write.csv(out, file = paste("HOSTresults", focal_taxon,"_", gsub(" ","",focal_host), "ITS.csv", sep = ""), row.names = T)
