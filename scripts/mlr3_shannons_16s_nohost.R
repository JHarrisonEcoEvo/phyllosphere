...
write.csv(var.imp, file = paste("variableImportanceshannonsISD_nohost_16s.csv"), row.names = T)
...
write.csv(var.impR, file = paste("variableImportanceReducedshannonsISD_nohost_16s.csv"), row.names = T)

write.csv(out, file = paste("results_shannonosISD_nohost_16s.csv"), row.names = F)
