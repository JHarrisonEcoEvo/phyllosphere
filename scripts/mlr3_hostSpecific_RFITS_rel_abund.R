...
write.csv(var.imp, file = paste("HOSTvariableImportance_RelAbund", focal_taxon, "_", gsub(" ","",focal_host), "ITS.csv", sep = ""), row.names = T)
# 
# ##########################################
...
# 
# write.csv(var.impR, file = paste("HOSTvariableImportanceReduced", focal_taxon, "_", gsub(" ","",focal_host), "ITS.csv", sep = ""), row.names = T)

write.csv(out, file = paste("HOSTresults_RelAbund", focal_taxon,"_", gsub(" ","",focal_host), "ITS.csv", sep = ""), row.names = T)
