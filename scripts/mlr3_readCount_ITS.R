...
write.csv(var.imp, file = paste("variableImportance_abundance_ITS.csv", sep = ""), row.names = T)
...
write.csv(var.impR, file = paste("variableImportanceReduced_abundance_ITS.csv", sep = ""), row.names = T)

write.csv(out, file = paste("results_abundance_ITS.csv", sep = ""), row.names = F)
